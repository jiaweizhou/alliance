...
class GrabcommodityrecordsController extends Controller
{
	...
	{ 
		...
		->select('grabcommodityrecords.*,grabcommodities.title,grabcommodities.version,grabcommodities.date,grabcommodities.number,grabcommodities.end_at,grabcommodities.islotteried,g2.count as winnercount,users.nickname,users.thumb')
