...
// 			}
	...
	public function actionWin()
	{
		$data=Yii::$app->request->post();
		$query = (new \yii\db\Query ())
		->select('grabcommodityrecords.id as flag, grabcommodityrecords.*,grabcommodities.isgot,grabcommodities.picture,grabcommodities.title,grabcommodities.version,grabcommodities.date,grabcommodities.winnernumber,grabcommodities.end_at,grabcommodities.islotteried,users.nickname,users.thumb')
		->from('grabcommodityrecords')
		->orderBy('grabcommodityrecords.created_at desc')
